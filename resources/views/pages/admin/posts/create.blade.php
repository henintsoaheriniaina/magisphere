<x-layouts.app title="Publier">
    ...
    <div class="lg:col-span-8">
        <x-back />
        <h1 class="my-10 text-3xl font-black md:text-4xl">Créer une Publication</h1>
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <input type="file" name="files[]" accept="video/*" x-ref="videoInput" multiple class="hidden"
                @change="handleFiles">
            <input type="file" name="files[]" accept=".pdf,.doc,.docx,.txt" x-ref="documentInput" multiple
                ...
                <div class="grid grid-cols-1 gap-4 pr-20 sm:grid-cols-3">
                    <template x-for="(file, index) in files" :key="index">
                        <div class="relative rounded-lg border p-2 dark:border-classic-white">
                            ...
                            <button type="button" class="auth-button absolute -right-3 -top-3"
